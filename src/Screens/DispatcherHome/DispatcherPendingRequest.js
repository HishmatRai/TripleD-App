...
export default function DispatcherPendingRequest(props) {
    let CardData = [
        {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles._jobs_tabs_main}>
                <TouchableOpacity style={styles._pending_jobs_btn} onPress={() => props.navigation.navigate("DispatcherPendingRequest")}>
                    <Text style={styles._pending_jobs_btn_text}>Pending Request</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles._completed_jobs_btn} onPress={() => props.navigation.navigate("DispatcherConfirmedRequest")}>
                    <Text style={styles._completed_jobs_btn_text}>Confirmed Request</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles._completed_jobs_btn} onPress={() => props.navigation.navigate("DispatcherCompletedJobs")}>
