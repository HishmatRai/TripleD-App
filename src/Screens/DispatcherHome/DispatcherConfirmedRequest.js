...
export default function DispatcherConfirmedRequest(props) {
  let CardData = [
    {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles._jobs_tabs_main}>
        ...
        >
          <Text style={styles._completed_jobs_btn_text}>Pending Request</Text>
        </TouchableOpacity>
        <TouchableOpacity
        ...
        >
          <Text style={styles._pending_jobs_btn_text}>Confirmed Request</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles._completed_jobs_btn}
                ...
                <View style={styles.card}>
                  ...
                  <View style={styles._confimed_main}>
                    ...
                    <TouchableOpacity style={styles._confimed_btn}>
                      <Text style={styles._confimed_btn_text}>Confirmed</Text>
                    </TouchableOpacity>
                  </View>
