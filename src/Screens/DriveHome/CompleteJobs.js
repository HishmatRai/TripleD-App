...
export default function CompleteJobs(props) {
    let CardData = [
        {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles._jobs_tabs_main}>
                <TouchableOpacity style={styles._completed_jobs_btn} onPress={() => props.navigation.navigate("DriveHome")}>
                    <Text style={styles._completed_jobs_btn_text}>Pending Jobs</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles._pending_jobs_btn} onPress={() => props.navigation.navigate("CompleteJobs")}>
                    <Text style={styles._pending_jobs_btn_text}>Completed Jobs</Text>
                </TouchableOpacity>
            </View>
            <ScrollView>
                {/* =====================> <===================== */}
                                    ...
                                    <View style={styles._Card_header_mian}>
                                        ...
                                        <View style={styles._Card_header_km_main}>
                                            <View style={styles._call_message_main}>
                                                <Text style={{ color: "white", fontSize: 13, marginBottom: 10 }}>Completed</Text>
                                            </View>
