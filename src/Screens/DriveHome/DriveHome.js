...
export default function DriveHome(props) {
    let CardData = [
        {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles._jobs_tabs_main}>
                <TouchableOpacity style={styles._pending_jobs_btn} onPress={() => props.navigation.navigate("DriveHome")}>
                    <Text style={styles._pending_jobs_btn_text}>Pending Jobs</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles._completed_jobs_btn} onPress={() => props.navigation.navigate("CompleteJobs")}>
